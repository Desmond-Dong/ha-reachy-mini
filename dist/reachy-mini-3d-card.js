!function(){"use strict";window.customCards=window.customCards||[],window.customCards.push({type:"reachy-mini-3d-card",name:"Reachy Mini 3D Card",description:"Real-time 3D visualization of Reachy Mini robot with visual configuration editor",preview:!0,documentationURL:"https://github.com/Desmond-Dong/ha-reachy-mini-card"}),window.THREE||console.error("THREE.js not loaded yet"),(async()=>{try{const t=(()=>{const t=document.getElementsByTagName("script"),e=t[t.length-1],i=e?.src||"";return i?i.substring(0,i.lastIndexOf("/")+1):"/hacsfiles/reachy-mini-3d-card/"})();console.log("Card base URL:",t),window.THREE||await n("https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.min.js"),await n("https://cdn.jsdelivr.net/npm/three@0.160.0/examples/js/controls/OrbitControls.js"),await n("https://cdn.jsdelivr.net/npm/three@0.160.0/examples/js/loaders/STLLoader.js");const{LitElement:e,html:i,css:o}=await s();class ReachyMini3DCard extends e{static get properties(){return{hass:Object,config:Object,_editing:{type:Boolean,state:!0},_loaded:{type:Boolean,state:!0}}}static get styles(){return o`
        :host {
          display: block;
          width: 100%;
          position: relative;
              ...
              <div class="config-panel open">
                ...
                <div class="config-item">
                  ...
                  <label style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
                    <input type="checkbox"
                           ?checked="${!1!==this.config?.show_controls}"
                  ...
                  <label style="display:flex;align-items:center;gap:8px;">
                    <input type="checkbox"
                           ?checked="${this.config?.xray_mode||!1}"
      ...
      `}resetCamera(){this.camera&&this.controls&&(this.camera.position.set(.3,.3,.5),this.controls.reset())}toggleAutoRotate(){this.updateConfig({auto_rotate:!this.config.auto_rotate})}applyPreset(t){const e={default:{height:400,show_controls:!0,auto_rotate:!1},compact:{height:300,show_controls:!1,auto_rotate:!0},detailed:{height:600,show_controls:!0,auto_rotate:!1,xray_mode:!0},minimal:{height:250,show_controls:!1,auto_rotate:!1}};this.updateConfig(e[t]||e.default)}}async function n(t){return new Promise((e,i)=>{const o=document.createElement("script");o.src=t,o.onload=e,o.onerror=i,document.head.appendChild(o)})}async function s(){return window.LitElement?{LitElement:window.LitElement,html:window.html,css:window.css}:(await n("https://cdn.jsdelivr.net/npm/lit@3.1.0/index.js"),await n("https://cdn.jsdelivr.net/npm/lit@3.1.0/decorators.js"),await n("https://cdn.jsdelivr.net/npm/lit@3.1.0/polyfill-support.js"),await n("https://cdn.jsdelivr.net/npm/@lit/reactive-element@1.6.0/reactive-element.js"),await n("https://cdn.jsdelivr.net/npm/lit@3.1.0/lit-element.js"),{LitElement:window.LitElement||window.LitElementElement,html:window.html||((t,...e)=>({strings:t,values:e})),css:window.css||((t,...e)=>t.join(""))})}customElements.define("reachy-mini-3d-card",ReachyMini3DCard),console.log("Reachy Mini 3D Card registered successfully")}catch(a){console.error("Error initializing Reachy Mini 3D Card:",a)}})()}();
