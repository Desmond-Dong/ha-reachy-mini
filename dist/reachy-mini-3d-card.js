!function(){"use strict";window.customCards=window.customCards||[],window.customCards.push({type:"reachy-mini-3d-card",name:"Reachy Mini 3D Card",description:"Real-time 3D visualization of Reachy Mini robot with direct daemon connection",preview:!0,documentationURL:"https://github.com/Desmond-Dong/ha-reachy-mini-card"}),(async()=>{try{const t=t=>new Promise((e,o)=>{const i=document.createElement("script");i.src=t,i.onload=e,i.onerror=o,document.head.appendChild(i)});let e,o,i;window.THREE||await t("https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.min.js"),await t("https://cdn.jsdelivr.net/npm/three@0.160.0/examples/js/controls/OrbitControls.js"),await t("https://cdn.jsdelivr.net/npm/three@0.160.0/examples/js/loaders/STLLoader.js"),window.LitElement?(e=window.LitElement,o=window.html,i=window.css):(await t("https://cdn.jsdelivr.net/npm/@lit/reactive-element@1.6.0/reactive-element.js"),await t("https://cdn.jsdelivr.net/npm/lit@3.1.0/lit-element.js"),e=window.LitElement||window.LitElementElement,o=window.html||((t,...e)=>({strings:t,values:e})),i=window.css||((t,...e)=>t.join("")));class ReachyMini3DCard extends e{static get properties(){return{hass:Object,config:Object,_editing:{type:Boolean,state:!0},_loaded:{type:Boolean,state:!0},_connectionStatus:{type:String,state:!0},_robotData:{type:Object,state:!0}}}static get styles(){return i`
          :host {
            display: block;
            width: 100%;
            position: relative;
